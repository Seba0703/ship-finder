...
public final class CircleCircleIntersection {
    ...
    public CircleCircleIntersection(Circle c1, Circle c2) {
        ...
        if (sqH > 0)
        {
            ...
            intersectionPoint1 = radicalPoint.add(versorRadicalLine.scale(distanceRadicalPointIntersectionPoints)).setScale(SCALE);
            intersectionPoint2 = radicalPoint.add(versorRadicalLine.scale(-distanceRadicalPointIntersectionPoints)).setScale(SCALE);
        }
        else
        {
            ...
            if (sqH == 0)
            {
                ...
                intersectionPoint = radicalPoint.setScale(SCALE);
                intersectionPoint1 = null;
                intersectionPoint2 = null;
                distanceRadicalPointIntersectionPoints = 0;
            }
