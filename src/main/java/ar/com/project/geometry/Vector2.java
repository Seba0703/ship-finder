...
public final class Vector2 implements Serializable {
    ...
    public Vector2 setScale(int scale) {
        return new Vector2(new BigDecimal(x).setScale(scale, RoundingMode.HALF_UP).doubleValue(),
                new BigDecimal(y).setScale(scale, RoundingMode.HALF_UP).doubleValue());
    }
}